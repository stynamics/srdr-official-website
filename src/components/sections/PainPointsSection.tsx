        ...
        <section className="bg-slate-50 py-24 md:py-32">
            <div className="container mx-auto px-4 md:px-8">
                <div className="text-center max-w-4xl mx-auto mb-20">
                    <h2 className="text-3xl md:text-5xl font-extrabold text-brand-blue mb-6 tracking-tight leading-[1.1]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mb-20">
                    {painPoints.map((point, idx) => (
                        ...
                        >
                            ...
                            <h3 className="text-xl font-extrabold text-brand-blue mb-3 tracking-tight">{point.title}</h3>
                            <p className="text-base text-slate-600 leading-relaxed font-medium">{point.desc}</p>
                        </motion.div>
                    ))}
                </div>
                ...
                >
                    ...
                    <h3 className="text-2xl md:text-3xl font-bold relative z-10 leading-[1.3] text-brand-gold/90 uppercase tracking-widest">
                        Total Transparency. Zero Exceptions.
                    </h3>
                    <p className="text-lg md:text-xl text-white font-medium mt-6 relative z-10 leading-relaxed">
