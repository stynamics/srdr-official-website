  ...
  const testimonials = [
    {
      ...
      videoThumbnail: "https://images.unsplash.com/photo-1487958449943-2429e8be8625?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
    },
    {
      id: 2,
      name: "Rajesh Kumar",
      ...
      videoThumbnail: "https://images.unsplash.com/photo-1518005020951-eccb494ad742?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
    },
    {
      id: 3,
      name: "Anita Menon",
      ...
      videoThumbnail: "https://images.unsplash.com/photo-1496307653780-42ee777d4833?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
    },
    {
      id: 4,
      name: "Vikram Reddy",
      ...
      videoThumbnail: "https://images.unsplash.com/photo-1431576901776-e539bd916ba2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
    },
    {
      id: 5,
      name: "Lakshmi Naik",
      ...
      rating: 5,
      image: "https://images.unsplash.com/photo-1485206412256-701ccc5b93ca?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
      ...
      videoThumbnail: "https://images.unsplash.com/photo-1449157291145-7efd050a4d0e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
    },
    {
      id: 6,
      name: "Amit Patel",
      ...
      videoThumbnail: "https://images.unsplash.com/photo-1459767129954-1b1c1f9b9ace?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
    }
  ];
    ...
    <div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-200">
              Hear what our satisfied clients have to say about their experience with SR DreamSpace Realty.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real feedback from real clients who trusted us with their construction and renovation projects.
            </p>
          </div>
      ...
      <section className="py-16 bg-blue-50">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Find Us on Google Reviews</h2>
          <p className="text-xl text-gray-600 mb-8">
            Check out our 4.9-star rating on Google Reviews with over 200 verified customer reviews.
          </p>
          <Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700">
            <a href="https://www.google.com/search?q=SR+DreamSpace+Realty+reviews" target="_blank" rel="noopener noreferrer">
              View Google Reviews
            </a>
          </Button>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-orange-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">Ready to Join Our Happy Clients?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Experience the same quality and satisfaction that our clients rave about. Start your construction project today!
          </p>
