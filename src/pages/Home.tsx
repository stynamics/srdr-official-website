  ...
  const services = [
    {
      title: "Construction",
      description:
        "New residential and commercial construction projects with modern techniques.",
      icon: "🏗️",
      slug: "construction",
    },
    {
    ...
    },
    {
      ...
      description:
        "Complete interior solutions for offices, homes, and commercial spaces.",
      icon: "🏠",
            ...
            <div className="max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Button
                  asChild
                  size="lg"
                  className="bg-orange-600 hover:bg-orange-700 text-white text-lg px-8 py-4 shadow-xl"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="text-lg px-8 py-4 border-white text-white hover:bg-white hover:text-blue-900 shadow-xl"
                >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <Card
                key={index}
                className="group hover:shadow-lg transition-all duration-300 hover:scale-105 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700"
              >
                <CardContent className="p-6 text-center">
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="group-hover:bg-blue-600 group-hover:text-white border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white"
                  >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Fully certified with comprehensive insurance coverage for
                      your peace of mind.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      We use only premium materials from trusted suppliers for
                      lasting results.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Committed to meeting deadlines without compromising on
                      quality.
                    </p>
                  </div>
                </div>
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-orange-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto text-gray-100">
            Get a free consultation and quote from Bangalore's most trusted
            construction company. Let's bring your vision to life!
          </p>
