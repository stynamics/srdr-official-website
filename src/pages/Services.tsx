  ...
  const services = [
    {
      ...
      description: "Complete construction services for residential and commercial projects with modern techniques and quality materials.",
    ...
    },
    {
      ...
      description: "Comprehensive renovation services to update and modernize your existing residential or commercial space.",
    ...
    },
    {
      ...
      description: "Professional interior fit-out services for offices, retail spaces, and residential properties.",
    ...
    },
    {
      ...
      description: "Professional project management services ensuring timely delivery and quality control for all construction projects.",
    ...
    },
    {
      ...
      description: "Full-service general contracting for large-scale residential and commercial construction projects.",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-200">
              Comprehensive construction and renovation solutions for residential and commercial projects in Bangalore.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose SR DreamSpace?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We combine experience, expertise, and commitment to deliver exceptional results for every project.
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-orange-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get a detailed quote for your construction or renovation project. Free consultation available.
          </p>
