...
const Packages = () => {
  const packages = [
    ...
    },
    {
      ...
      popular: true,
      description:
        "Most popular choice with premium materials and modern design",
      features: [
    ...
    },
    {
      ...
      popular: false,
      description:
        "Luxury construction with smart home integration and premium finishes",
      features: [
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              Choose the perfect construction package that fits your budget and
              requirements. From economy to premium, we have something for
              everyone.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Select from our carefully crafted packages designed to meet
              different budgets and requirements. Each package includes
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {packages.map((pkg, index) => (
              ...
              >
                ...
                <CardHeader
                  className={`text-center ${pkg.popular ? "pt-16" : "pt-8"}`}
                >
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <Card className="bg-white dark:bg-gray-800 border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  Our consultation includes site analysis, requirement
                  discussion, preliminary design concepts, cost estimation, and
                  timeline planning. Premium packages include 3D previews and
                  site visits.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white dark:bg-gray-800 border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  Absolutely! All our packages can be customized based on your
                  specific requirements. We'll work with you to create a
                  solution that fits your budget and needs perfectly.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white dark:bg-gray-800 border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  We handle all necessary permits and approvals as part of our
                  service. Our team is well-versed with local regulations and
                  will ensure all documentation is in order.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Contact our experts today for a free consultation and let's bring
            your vision to life.
          </p>
