...
const ProjectDetail = () => {
  ...
  const projects = {
    "luxury-villa-construction": {
      ...
      duration: "8 months",
      description:
        "A stunning 4-bedroom luxury villa featuring contemporary architecture, smart home automation, premium finishes, and sustainable construction practices. This project showcases our expertise in modern residential construction with attention to every detail.",
      features: [
    ...
    "office-complex-renovation": {
      ...
      duration: "4 months",
      description:
        "Complete transformation of a 5-story office complex with modern amenities, eco-friendly features, and contemporary design. The renovation included structural upgrades, HVAC systems, and sustainable building practices.",
      features: [
        "Modern HVAC System",
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-orange-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Let us bring your vision to life with the same quality and
            dedication shown in this project.
          </p>
