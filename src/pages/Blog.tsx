...
const Blog = () => {
  const blogPosts = [
    {
      ...
      excerpt: "Discover the latest construction trends shaping Bangalore's skyline, from sustainable building materials to smart home technology.",
    ...
    },
    {
      ...
      excerpt: "Learn how to plan and budget for your home renovation project with expert tips on cost estimation and avoiding common pitfalls.",
    ...
    },
    {
      ...
      excerpt: "Explore green building techniques and materials that reduce environmental impact while creating healthier living spaces.",
    ...
    },
    {
      ...
      excerpt: "Essential checklist for selecting a reliable construction contractor, including license verification, portfolio review, and contract terms.",
    ...
    },
    {
      ...
      excerpt: "From minimalist aesthetics to biophilic design, discover the interior trends that are transforming homes and offices in Bangalore.",
    ...
    },
    {
      ...
      excerpt: "Navigate the complex world of construction permits, BBMP approvals, and regulatory requirements for your building project.",
  ...
  const categories = ["All", "Trends", "Tips", "Sustainability", "Guide", "Design", "Legal"];
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              Expert insights, tips, and industry news to help you make informed decisions about your construction projects.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-foreground mb-8 font-playfair">Featured Article</h2>
          <Card className="overflow-hidden hover:shadow-2xl transition-all duration-500 border-0 shadow-xl bg-card">
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <CardContent className="p-8 lg:p-12 flex flex-col justify-center">
                ...
                <Button asChild className="w-fit bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg hover:shadow-xl transition-all duration-300">
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900/30">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-foreground mb-12 font-playfair text-center">Latest Articles</h2>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.slice(1).map((post, index) => (
              <Card key={post.id} className="group hover:shadow-2xl transition-all duration-500 overflow-hidden border-0 shadow-lg bg-card hover:scale-105" style={{ animationDelay: `${index * 100}ms` }}>
                <div className="relative overflow-hidden">
                  <img
                    src={post.image}
                    alt={post.title}
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button asChild variant="outline" size="sm" className="bg-white dark:bg-gray-800 text-orange-600 dark:text-orange-400 border-orange-600 dark:border-orange-400 hover:bg-orange-600 hover:text-white hover:border-orange-600 transition-all duration-300">
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Subscribe to our newsletter for the latest construction tips, industry news, and project updates.
          </p>
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4 font-playfair">Need Construction Advice?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Our experts are ready to help with your construction and renovation questions.
          </p>
