      ...
      <section className="relative py-24 bg-gradient-to-br from-blue-900 via-blue-800 to-purple-800 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <Button
            asChild
            variant="outline"
            className="mb-6 border-white/30 text-white hover:bg-white/10 backdrop-blur-sm"
          >
            <Link to="/blog">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-12 p-6 bg-gray-50 dark:bg-gray-900/50 rounded-2xl border border-gray-200 dark:border-gray-800">
              ...
              <div className="flex space-x-3">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className="hover:bg-green-600 hover:text-white hover:border-green-600 transition-all duration-300"
                >
                  <Share2 className="h-4 w-4 mr-2" />
                  WhatsApp
                </Button>
            ...
            <div className="mt-16 p-8 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-2xl border border-blue-200 dark:border-blue-800">
              <div className="flex items-start space-x-6">
                ...
                />
                <div>
                  <h4 className="text-2xl font-bold text-foreground mb-3 font-playfair">
                    {post.author}
                  </h4>
            ...
            {/* Related Articles */}
            <div className="mt-16">
              <h3 className="text-3xl font-bold text-foreground mb-8 font-playfair">
                Related Articles
              </h3>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="p-6 border border-gray-200 dark:border-gray-800 rounded-2xl hover:shadow-xl transition-all duration-300 bg-card hover:scale-105">
                  <h4 className="font-semibold text-foreground mb-3 text-lg font-playfair">
                    Complete Guide to Home Renovation Budgeting
                  </h4>
                  <p className="text-muted-foreground text-sm mb-4 leading-relaxed">
                    Learn how to plan and budget for your home renovation
                    project...
                  </p>
                  <Link
                    to="/blog/renovation-budget-guide"
                ...
                <div className="p-6 border border-gray-200 dark:border-gray-800 rounded-2xl hover:shadow-xl transition-all duration-300 bg-card hover:scale-105">
                  ...
                  <p className="text-muted-foreground text-sm mb-4 leading-relaxed">
                    Explore green building techniques and materials that reduce
                    environmental impact...
                  </p>
                  <Link
                    to="/blog/sustainable-construction"
                    className="text-blue-600 hover:text-blue-700 text-sm font-medium transition-colors duration-300"
                  >
                    Read More →
                  </Link>
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Get expert advice and a free consultation for your construction
            needs.
          </p>
